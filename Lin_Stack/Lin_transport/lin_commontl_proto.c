...
/* check diagnostic service is belong to class II or class III */
    ...
    case SERIVCE_FAULT_MEMORY_CLEAR:
      ...
      break;
    case SERIVCE_ECU_RESET:
      lin_diag_services_flag[DIAGSRV_ECU_RESET_ORDER] = 1;
      break;
    case SERIVCE_TESTER_PRESENT:
      lin_diag_services_flag[DIAGSRV_TESTER_PRESENT_ORDER] = 1;
      break;
    case SERIVCE_ROUTINE_CONTROL:
      lin_diag_services_flag[DIAGSRV_ROUTINE_CONTROL_ORDER] = 1;
      break;
